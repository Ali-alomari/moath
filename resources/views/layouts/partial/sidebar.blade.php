    ...
    <nav class="vertnav navbar navbar-light">
        ...
        <ul class="navbar-nav flex-fill w-100 mb-2">
            <li class="nav-item dropdown">
                <a href="{{ route('dashboard') }}" data-toggle="collapse" aria-expanded="false"
                    class="dropdown-toggle nav-link">
                    <i class="fe fe-home fe-16"></i>
                    <span class="ml-3 item-text">{{ trans('sidebar.dashboard') }}</span><span
        ...
        <ul class="navbar-nav flex-fill w-100 mb-2">
            <li class="nav-item dropdown">
                <a href="#ui-elements" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle nav-link">
                    ...
                    <span class="ml-3 item-text">{{ trans('sidebar.Categories') }}</span>
                </a>
                <ul class="collapse list-unstyled pl-4 w-100" id="ui-elements">
                    <li class="nav-item">
                        <a class="nav-link pl-3" href="{{ route('category.index') }}"><span
                                class="ml-1 item-text">{{ trans('sidebar.Category List') }}</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link pl-3" href="{{ route('category.create') }}"><span
                                class="ml-1 item-text">{{ trans('sidebar.New Category') }}</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link pl-3" href="#"><span
                                class="ml-1 item-text">{{ trans('sidebar.Delete Category') }}</span></a>
                    </li>
                </ul>
            ...
            <li class="nav-item dropdown">
                <a href="#tables" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle nav-link">
                    ...
                    <span class="ml-3 item-text">{{ trans('sidebar.Products') }}</span>
                </a>
                <ul class="collapse list-unstyled pl-4 w-100" id="tables">
                    <li class="nav-item">
                        <a class="nav-link pl-3" href="{{ route('product.index') }}"><span
                                class="ml-1 item-text">{{ trans('sidebar.Products List') }}</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link pl-3" href="{{ route('product.create') }}"><span
                                class="ml-1 item-text">{{ trans('sidebar.New Product') }}</span></a>
                    </li>
            ...
            <li class="nav-item w-100">
                <a class="nav-link" href="widgets.html">
                    ...
                    <span class="ml-3 item-text">{{ trans('sidebar.widgets') }}</span>
            ...
            <li class="nav-item dropdown">
                <a href="#charts" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle nav-link">
                    ...
                    <span class="ml-3 item-text">{{ trans('sidebar.Charts') }}</span>
                </a>
